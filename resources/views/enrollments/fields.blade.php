...
<div class="form-group col-sm-6">
    {!! Form::label('Last_School_Attended', 'Last School Attended:') !!}
    {!! Form::text('Last_School_Attended', null, ['class' => 'form-control','maxlength' => 500,'maxlength' => 500]) !!}
</div>

<!-- Date Graduated Field -->
<div class="form-group col-sm-6">
    {!! Form::label('Date_Graduated', 'Date Graduated:') !!}
    {!! Form::text('Date_Graduated', null, ['class' => 'form-control','id'=>'Date_Graduated']) !!}
</div>
